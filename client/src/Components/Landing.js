        ...
        <div>   
            ...
            <div className='home'>
                ...
                <div className='container23' >
                    ...
                    <h3 style={{textAlign:'left',fontSize:'40px',marginLeft:'120px'}} className='text2'>Join with us to make your special occasions are <br />memorable and beautiful.</h3><br /><br /><br/>
