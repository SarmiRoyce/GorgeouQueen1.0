...
function Ourservices() {
  return (
    ...
    <div className='content'>
        <h1 style={{fontSize:'60px',textAlign:'center',fontWeight:'bolder'}}>Our Services</h1><br/>
        ...
        <a href='/Profile'><img src="https://freeonlinedeal.files.wordpress.com/2015/06/parlour-services.jpg" alt="Beauty Parlour and Salon Visits" style={{marginTop:'20px',borderRadius:'20px', marginLeft:'160px'}}/></a><br/>
